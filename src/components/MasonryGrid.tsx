...
const MasonryGrid = () => {
  ...
  return (
  <Container isHomePage={pathname === "/"} className="columns-2 md:columns-3 lg:columns-4 flex-wrap">
     <ImageContainer href="/work/7bridges" className="mb-4">
          <StyledImage src={SevenBridges} alt="7Bridges App"  width={200} height={200}/>
          <TextContainer>
     ...
     <ImageContainer href="/work/zown" className="mb-4">
          <StyledImage src={Zown} alt="Zown App"  width={200} height={200}/>
          <TextContainer>
        ...
        <ImageContainer href="/work/scouty" className="mb-4">
          <StyledImage src={Scouty} alt="Scouty App"  width={200} height={200}/>
          <TextContainer>
   ...
   <ImageContainer className="mb-4" href="/work/rota" style={{width: 250}}>
          <StyledImage src={RotaHome} alt="Rota App" style={{width: 300}} width={300} height={250}/>
          <TextContainer>
        ...
        <ImageContainer href="/work/moulin-rouge" style={{maxWidth: 350}} className="mb-4">
          <StyledImage src={MoulinRouge} alt="Sony Moulin Rouge website" width={200} height={200}/>
          <TextContainer>
        ...
        <ImageContainer href="work/daye-blog" className="mb-4">
          <StyledImage src={DayeVitals} alt="Vitals website" width={200} height={200}/>
          <TextContainer>
            <h3>Daye - Blog Site</h3>
            <p>Built with: React, Typsecript, Gatsby, Node</p>
          </TextContainer>
        </ImageContainer>
        <ImageContainer className="mb-4" href="/work/tfa/">
          <StyledImage src={tfa} alt="Tfa website" width={200} height={200}/>
          <TextContainer>
...
const Container = styled.div<{isHomePage: boolean}>`
  ...
  @media only screen and (max-width: 768px) {
    padding: 5px;
    padding-top: ${props => props.isHomePage ? '230px' : '180px'}
  }
`
